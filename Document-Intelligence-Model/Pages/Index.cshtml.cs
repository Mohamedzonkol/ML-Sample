...
namespace Document_Intelligence_Model.Pages;
...
public class IndexModel : PageModel
{
    ...
    {
        string endpoint = "https://azuredocumentintelligence132.cognitiveservices.azure.com/";
        string apiKey = "6YJZXqCxe0NeXqnGF590jK93VzAr3bjfvcpA53BjtWFOUqfc23s1JQQJ99BBACYeBjFXJ3w3AAALACOG4UuZ";
        ...
        foreach (AnalyzedDocument receipt in receipts.Documents)
        {
            ...
            if (receipt.Fields.TryGetValue("TransactionDate", out DocumentField transactionDate))
            {
                ...
                {
                    //string date = transactionDate.Content;
                    Result.TransactionDate = $"Transaction Date: '{transactionDate.Content}', with confidence {transactionDate.Confidence}";
                }
            }
