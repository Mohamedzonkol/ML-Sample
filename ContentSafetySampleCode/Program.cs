...
namespace ContentSafetySampleCode
{
    ...
    public class Program
    {
        static async Task Main(string[] args)
        {
            ...
            string endpoint = "https://content-test21.cognitiveservices.azure.com/";
            string subscriptionKey = "6TNJ35an7O4jWxulcuUODZu1caKSb0sGDO32JyrY7WxjmAazUfMZJQQJ99BBACYeBjFXJ3w3AAAHACOGGn9M";
            ...
            Console.WriteLine("Enter Your Content to test");
